...
const App: React.FC = () => {
  ...
  return (
    ...
    <div className="w-full absolute left-0 top-0 h-24 bg-[#1e55a9] z-50">
      <a href="http://northwell.edu/katz-institute-for-womens-health">
          ...
          <table className="table-auto w-full border-collapse">
            <thead>
              <tr className='bg-[#1e55a9] border text-black'>
                <th style={{ fontFamily: "GalaxiePolaris"}} className="border text-[6px] xs:text-[8px] sm:text-[12px] lg:text-sm lg:w-52 md:w-40 sm:w-12 p-1 sm:py-2"><div className='text-white'>Member Name</div></th>
